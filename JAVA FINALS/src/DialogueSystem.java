...
public class DialogueSystem extends JPanel {
    ...
    public DialogueSystem(JFrame frame) {
        ...
        try {
            Font customFont = Font.createFont(Font.TRUETYPE_FONT, new java.io.File("Daydream.ttf")).deriveFont(30f);
        ...
        dialogue = new String[] {
                ...
                "You get 5 attempts and there are several ways to deplete your them.",
        ...
        try {
            Font customFont = Font.createFont(Font.TRUETYPE_FONT, new java.io.File("Daydream.ttf")).deriveFont(19f);
...
class NPC extends JLabel implements Runnable {
    ...
    public NPC() {
        String happyImagePath = "HAPPY.png";
    ...
    public void run() {
        while (running) {
            try {
                ...
                File happyImageFile = new File("HAPPY.png");
                if (happyImageFile.exists()) {
                    SwingUtilities.invokeLater(() -> {
