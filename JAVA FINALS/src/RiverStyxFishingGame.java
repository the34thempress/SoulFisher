...
public class RiverStyxFishingGame extends JPanel {
    ...
    private final String[] soulImages = {"snickerbloom.png", "mournox.png", "vexilith.png", "skittershade.png", "freakazoid.png"};
    ...
    public RiverStyxFishingGame(JFrame frame) {
        ...
        loadCustomBackground("gamebg.png");
        generateChecklist();
    ...
    private void loadCustomFont() {
        try {
            customFont = Font.createFont(Font.TRUETYPE_FONT, new File("Daydream.ttf")).deriveFont(15f);
        } catch (Exception e) {
            e.printStackTrace();
